...
const user = {
    ...
    addNew: async function(loginID, firstName, lastName, displayName, avatarPNG,password ) {
        const vars = '(login_id, first_name, last_name, display_name, avatar_dirct,password)';
        const data = `(${loginID}, '${firstName}', '${lastName}', '${displayName}', '${avatarPNG}', '${password}')`;
